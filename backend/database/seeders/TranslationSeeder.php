...
class TranslationSeeder extends Seeder
{
    public function run(): void
    {
        $translations = [
            ...
            'roles.page_subtitle_platform' => [
                'en' => 'Manage platform roles and their permission sets.',
                'am' => 'የፕላትፎርም ሚናዎችና ፈቃዳቸውን ያስተዳድሩ።',
                'om' => 'Gahee platformii fi hayyama isaanii bulchi.',
                'ti' => 'ሚናታት መደበኛ ስርዓትን ፍቓዳቶምን ምምሕዳር።',
            ],
            'roles.page_subtitle_hospital' => [
                'en' => 'Manage hospital roles and their permission sets.',
                'am' => 'የሆስፒታል ሚናዎችና ፈቃዳቸውን ያስተዳድሩ።',
                'om' => 'Gahee hospitaala fi hayyama isaanii bulchi.',
                'ti' => 'ሚናታት ሆስፒታልን ፍቓዳቶምን ምምሕዳር።',
            ],
            'roles.new_role' => [
                'en' => 'New Role',
                'am' => 'አዲስ ሚና',
            ...
            'roles.hospital_notice' => [
                'en' => 'You can manage permissions for doctors, receptionists, patients and any custom roles within your hospital. Deleting system roles and modifying platform-level roles is restricted.',
                'am' => 'ለሐኪሞች፣ ሪሴፕሽኒስቶች፣ ታካሚዎች እና ለሆስፒታልዎ ማናቸውም ብጁ ሚናዎች ፈቃዶችን ማስተዳደር ይችላሉ። የስርዓት ሚናዎችን መሰረዝ እና የፕላትፎርም ደረጃ ሚናዎችን ማሻሻል የተከለከለ ነው።',
                'om' => 'Hayyama doktarootaa, simattootaa, dhukkubsatootaa fi gahee dhuunfaa hospitaala keessaniif bulchuu dandeessu. Gahee siistamaa haquun fi gahee sadarkaa platformii jijjiiruu dhorkaa dha.',
                'ti' => 'ፍቓዳት ንሓካይም፣ ሰበ-ስልጣን ቅበላ፣ ሕሙማትን ዝኾነ ብዕሊ ዝተሰርሐ ሚናን ናይ ሆስፒታልኩም ምምሕዳር ትኽእሉ። ናይ ስርዓት ሚናታት ምሕካምን ናይ መደበኛ ስርዓት ሚናታት ምልዋጥን ዝተኸልከለ እዩ።',
            ],
            'roles.system_badge' => [
                'en' => 'SYSTEM',
                'am' => 'ሲስተም',
            ...
            'roles.selected_count' => [
                'en' => '{count} of {total} selected',
                'am' => '{count} ከ{total} ተመርጧል',
                'om' => '{count} kan {total} filatame',
                'ti' => '{count} ካብ {total} ተሪሒጹ',
            ],
            ...
            'roles.no_permissions_found' => [
                'en' => 'No permissions found',
                'am' => 'ምንም ፈቃዶች አልተገኙም',
                'om' => 'Hayyamni hin argamne',
                'ti' => 'ፍቓዳት ኣይተረኽቡን',
            ],
            'roles.try_different_search' => [
                'en' => 'Try a different search term.',
                'am' => 'ሌላ የፍለጋ ቃል ይሞክሩ።',
                'om' => 'Jecha barbaachaa biraa yaalii.',
                'ti' => 'ካልእ ቃል ድለ ፈትን።',
            ],
            'roles.saving' => [
                'en' => 'Saving…',
            ...
            'roles.description_label' => [
                'en' => 'Description',
                'am' => 'መግለጫ',
                'om' => 'Ibsa',
                'ti' => 'መግለጺ',
            ],
            'roles.total_permissions' => [
                'en' => 'Total Permissions',
                'am' => 'ጠቅላላ ፈቃዶች',
                'om' => 'Hayyama Waliigalaa',
                'ti' => 'ጠቕላላ ፍቓዳት',
            ],
            'roles.type_label' => [
                'en' => 'Type',
            ...
            'roles.role_name_label' => [
                'en' => 'Role Name',
                'am' => 'የሚና ስም',
                'om' => 'Maqaa Gahee',
                'ti' => 'ስም ሚና',
            ],
            'roles.role_name_placeholder' => [
                'en' => 'e.g. nurse, lab_technician',
                'am' => 'ለምሳሌ፦ nurse, lab_technician',
                'om' => 'Fkn: nurse, lab_technician',
                'ti' => 'ንኣብ: nurse, lab_technician',
            ],
            'roles.description_placeholder' => [
                'en' => 'Short description (optional)',
                'am' => 'አጭር መግለጫ (አማራጭ)',
                'om' => 'Ibsa gabaabaa (dirqama miti)',
                'ti' => 'ሓጺር መግለጺ (ምርጫ)',
            ],
            'roles.save_changes' => [
                'en' => 'Save Changes',
            ...
            'roles.delete_role_title' => [
                'en' => 'Delete Role',
                'am' => 'ሚናን ሰርዝ',
                'om' => 'Gahee Haqi',
                'ti' => 'ሚና ሕደጎ',
            ],
            'roles.delete_irreversible' => [
                'en' => 'This action cannot be undone.',
                'am' => 'ይህ ድርጊት ሊቀለበስ አይችልም።',
                'om' => 'Tarkaanfiin kun deebi\'uu hin danda\'u.',
                'ti' => 'እዚ ስጉምቲ ክምለስ ኣይከኣልን።',
            ],
            'roles.delete_confirm_text' => [
                'en' => 'Are you sure you want to delete',
                'am' => 'እርግጠኛ ነዎት መሰረዝ ይፈልጋሉ',
                'om' => 'Dhugumatti haqi barbaaddaa',
                'ti' => 'ከምስሰርዝዎ ርግጸኛ ዲኹም',
            ],
            'roles.delete_perm_warning' => [
                'en' => 'All permission assignments will be removed.',
                'am' => 'ሁሉም የፈቃድ ምደቦች ይሰረዛሉ።',
                'om' => 'Ramaddiin hayyamaa hundi ni haqqama.',
                'ti' => 'ኩሉ ዝተዋህቦ ፍቓዳት ክሰረዝ እዩ።',
            ],
            'roles.permissions_enabled' => [
                'en' => '{count} of {total} permissions enabled',
                'am' => '{count} ከ{total} ፈቃዶች ነቃ',
                'om' => '{count} kan {total} hayyamaa hojii irratti jiru',
                'ti' => '{count} ካብ {total} ፍቓዳት ዝሰርሑ',
            ],
            'roles.no_roles' => [
                'en' => 'No roles found.',
                'am' => 'ምንም ሚናዎች አልተገኙም።',
                'om' => 'Gaheen hin argamne.',
                'ti' => 'ምንም ሚናታት ኣይተረኽቡን።',
            ],
