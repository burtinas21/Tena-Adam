        ...
        >
          <div>
            ...
            <p class="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
              Manage your contact information and keep your Smart Care account
              secure.
            </p>
          </div>
          <!-- Account Status -->
        ...
        <div class="px-6 pb-6 sm:px-8">
          ...
          >
            ...
            <div class="flex items-end gap-4">
              ...
              >
                <UserRound class="h-11 w-11 text-[#004795]" />
              </div>
              <!-- Information -->
              <div class="pb-1">
                ...
                <div class="mt-1 flex flex-wrap items-center gap-2">
                  ...
                  <span class="text-sm text-slate-500"> Hospital Staff </span>
                </div>
              </div>
            </div>
            <!-- Security Status -->
            ...
            >
              ...
              <div>
                ...
                <p class="mt-2 text-xs leading-5 text-slate-400">
                  A verification link may be required when changing your email
                  address.
                </p>
              </div>
              <!-- Phone -->
              <div>
                ...
                <p class="mt-2 text-xs leading-5 text-slate-400">
                  Make sure your phone number is active and reachable.
                </p>
              </div>
                ...
                <div class="flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="mt-1 text-xs leading-5 text-slate-500">
                      You are registered as a Receptionist. Your hospital, role,
                      permissions, and access level are managed by your Hospital
                      Administrator.
                    </p>
                    <div class="mt-3">
                      <span
                        class="inline-flex items-center rounded-lg bg-white px-3 py-1.5 text-xs font-bold text-[#004795] ring-1 ring-blue-100"
                      >
                        Receptionist
                      </span>
                    </div>
            ...
            <div class="flex gap-3">
              ...
              <div>
                ...
                <p class="mt-1 text-xs leading-5 text-amber-700">
                  Never share your password with anyone. Your Hospital
                  Administrator manages your role and permissions.
                </p>
              </div>
            </div>
          </div>
